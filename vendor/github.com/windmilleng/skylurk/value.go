...
import (
	...
	"github.com/windmilleng/skylurk/internal/compile"
)
...
// TODO(nick): This allows Windmill to see if the function depends on any dynamic values.
// This is probably the wrong approach. A better approach would be either to
// 1) Add hooks to customize the behavior of the lambda operator,
//    so that it could return a dynamicValue if it captures a dynamic value.
// 2) Move the concept of dynamic values into Skylurk properly.
func (fn *Function) FreeVars() Tuple {
	return fn.freevars
}
